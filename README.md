...
- **88 tools**, one endpoint, one config file.
...
| **Jobs & introspection** | `job_run` `job_status` `job_list` `job_logs` `mcp_health` `mcp_stats` `audit_export` `plan_mutation` `confirm_mutation` |
