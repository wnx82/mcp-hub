...
sudo test -f "$prefix/core/limits.py"
sudo test -f "$prefix/tools/inventory.py"
sudo test -f "$prefix/tools/registry.py"
sudo test -f "$prefix/tools/ssh.py"
sudo test -f "$prefix/tools/cloudflare.py"
sudo test -f "$prefix/tools/dsm.py"
sudo test -f "$prefix/docs/integration-evaluation.md"
