...
- [x] Nettoyer les artefacts locaux du depot avant release (`__pycache__`, cache Ruff) si necessaire via `.gitignore` et checks
- [x] Ajouter un mini jeu de fixtures de config de test pour verifier les exemples sans toucher a un vrai homelab
...
- [x] Ajouter un exemple de `endpoints.yaml` pour montrer comment configurer `endpoints_health`
