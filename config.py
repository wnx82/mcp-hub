...
RATE_LIMIT_PER_MINUTE = env_int("MCP_RATE_LIMIT_PER_MINUTE", 120)
MAX_ARGUMENT_BYTES = env_int("MCP_MAX_ARGUMENT_BYTES", 200_000)
MAX_CONCURRENT_PER_HOST = env_int("MCP_MAX_CONCURRENT_PER_HOST", 4)
